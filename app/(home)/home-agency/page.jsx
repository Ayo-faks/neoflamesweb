...
export const metadata = {
  title: "NeoFlames || AI Automation Agency",
};
                    ...
                    >
                      ...
                      <div className="ptf-phone-block">
                        ...
                        <div className="ptf-phone-block__phone">
                          <a href="tel:+447765614696">+447765614696</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row">
                  <div className="col-lg-5 offset-lg-7">
                    ...
                    >
                      ...
                      Our determination to get the best from the latest technology has led to our deep understanding of artificial intelligence (AI) and machine learning as it relates to marketing, which we use to add value to the whole agency.
                      </p>
                      <p className="fz-18" style={{ maxWidth: "30rem" }}>
                      Our AI automation services
In addition to using AI to segment client data and help target audiences more effectively, it’s used to customise content and automate repetitive tasks, freeing up time to focus on strategy and creativity, driving better results for your business.
                      </p>
                    </div>
                    {/* <!--Spacer--> */}
                    <div
